...
const stakingGuides = [
  {
    ...
    details: [
      "Connect wallet",
      "Press approve to allow your $AXL to work the staking contract. Please wait for the transaction to confirm. (If you don't see the 'Approve', button you are likely already approved.)",
