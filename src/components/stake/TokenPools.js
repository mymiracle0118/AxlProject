...
const stakingPoolData = [
  ...
  {label: "Wallet Balance", value: "0.0 $AXL"},
  {label: "Staked", value: "0.0 $AXL"},
  {label: "Earned", value: "0.0000 $AXL"},
]
          ...
          <CardContent>
            ...
            <Box mt={3}>
              <TextField 
                ...
                InputProps={{
                  startAdornment: <InputAdornment position="start">$AXL</InputAdornment>,
                  autoComplete: "off"
                }}
